...
excerpt: "Complete guide to processing customer returns and managing refunds in Kelola. Learn how to record returns, handle different refund types, and track returned inventory."
readingTime: 5
...
<!-- TODO: Screenshot - History screen with search -->
...
<!-- TODO: Screenshot - Return item selection -->

### Step 3: Select Return Method

| Method | When to Use | Process |
|--------|-------------|---------|
| **Cash Refund** | Customer wants money back | Return cash or transfer |
| **Store Credit** | Customer will buy later | Credit added to customer account |
| **Exchange** | Swapping for different item | Return + new sale combined |
| **Repair** | Item will be fixed | Note for tracking |
...
<!-- TODO: Screenshot - Customer credit balance -->
...
**Q: Can I return an item without the original transaction?**
A: It's best practice to find the original transaction. If you can't find it, you can manually adjust stock, but this won't track the return properly.

**Q: What happens to my sales reports when I process a return?**
A: Returns are subtracted from your sales totals. The original sale is adjusted to show the net amount after returns.

**Q: Can customers return items from any location?**
A: This depends on your business policy. Kelola tracks which business location made the original sale.

**Q: How do I handle returns for items bought on credit/unpaid?**
A: If the original sale was unpaid, you can cancel the debt or adjust the balance owed.

**Q: Can I set a time limit for returns?**
A: Yes, establish and communicate your return policy. Kelola doesn't enforce time limits - that's up to your business policy.
